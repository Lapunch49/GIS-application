    ...
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "xmldom" has been externalized for browser compatibility. Cannot access "xmldom.${key}" in client code.`);
        }
      }
    }));
  }
...
var require_jxon = __commonJS({
  "node_modules/jxon/jxon.js"(exports, module) {
    (function(root, factory) {
      if (typeof define === "function" && define.amd) {
        ...
        if (typeof window === "object" && window.DOMImplementation && window.XMLSerializer && window.DOMParser) {
          ...
          module.exports = factory(require_xmldom(), true);
        }
      } else {
...
// node_modules/togpx/index.js
var require_togpx = __commonJS({
  "node_modules/togpx/index.js"(exports, module) {
    var JXON = require_jxon();
...
//# sourceMappingURL=chunk-JNVIXK3Y.js.map
